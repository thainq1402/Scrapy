...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    # Gửi request đến đường link trên để lấy user agent
    # F12 -> netwwork -> docs -> reload lại web -> lướt xuống cuối đọc user-agent
    ...
    # Dùng random các user-agent khác nhau để thực hiện request
